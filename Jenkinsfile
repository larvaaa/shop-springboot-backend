pipeline {
    ...
    // MSA 특성상 각 서비스 빌드를 동시에(병렬로) 진행하여 시간을 단축합니다.
    stages {
        stage('1. Checkout') {
            steps {
            ...
            parallel {
                ...
                stage('Apigateway Service') {
                    ...
                    steps {
                        ...
                        // Gradle 멀티 모듈 특정 서비스만 빌드
                        sh 'chmod +x gradlew'
                        sh './gradlew :apigateway-service:clean :apigateway-service:build -x test'
                ...
                stage('Admin Service') {
                    ...
                    steps {
                        ...
                        // Gradle 멀티 모듈 특정 서비스만 빌드
                        sh 'chmod +x gradlew'
                        sh './gradlew :admin-service:clean :admin-service:build -x test'
                ...
                stage('Member Service') {
                    ...
                    steps {
                        ...
                        sh 'chmod +x gradlew'
                        sh './gradlew :member-service:clean :member-service:build -x test'
                ...
                stage('Store Service') {
                    ...
                    steps {
                        ...
                        sh 'chmod +x gradlew'
                        sh './gradlew :store-service:clean :store-service:build -x test'
